...
var roomManagerAPI=require('../../lib/RoomManagerAPI');
 ...
 */
	...
	it.skip('POST /rooms/{:roomId}/resources/{:roomResourceId}, Verify the status 200',function(done){
					
			roomsAPI
				.editResourceOfRoom
					(token,room._id,resourceAsoc.body.resources[0]._id,sendJson,function(err,resourceSpec){

						console.log('roomId : '+room._id+' resource id :'
							+resourceSpec.body);
